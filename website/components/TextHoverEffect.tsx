...
export const TextHoverEffect = ({
  ...
  return (
    <svg
      ...
      className="select-none z-50 relative"
    >
      <defs>
        <linearGradient
          id="textGradient"
      ...
      {/* Hidden stroke layer that appears on hover */}
      <text
        x="50%"
        y="50%"
        textAnchor="middle"
        ...
        strokeWidth="1"
        className="fill-transparent stroke-white text-[80px] font-black opacity-60 transition-opacity duration-300"
        style={{ opacity: hovered ? 0.8 : 0 }}
      >
        {text}
      </text>

      {/* Drawing animation layer */}
      <motion.text
        x="50%"
        y="50%"
        textAnchor="middle"
      ...
      <text
        ...
        strokeWidth="1.2"
        mask="url(#textMask)"
        className="fill-transparent text-[80px] font-black"
      >
        {text}
      </text>
    </svg>
